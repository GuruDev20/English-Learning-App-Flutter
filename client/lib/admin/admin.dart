...
class _AdminScreenState extends State<AdminScreen> {
  ...
  Future<void> fetchCollectionNames() async {
    try {
      final response = await http.get(Uri.parse('http://${URL}:3000/collectionNames'));
  ...
  Future<void> updateCollectionName(String oldName, String newName) async {
    try {
      final response = await http.put(
        Uri.parse('http://${URL}:3000/updateCollectionName'),
  ...
  Future<void> collectionNameDelete(String name) async {
    try {
      final response = await http.delete(
        Uri.parse('http://${URL}:3000/deleteCollectionName'),
